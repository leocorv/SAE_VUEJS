    ...
    <div class="flex-col mt-2 mr-5">
        ...
        <form>
            <div class="flex flex-col items-start mt-3">
                ...
                <input class="peer border-solid border-2 border-gray-700/10 min-w-full rounded-xl text-base p-1" type="password" id="oldpassword" v-model="oldpassword" :readonly="!editing" />
            </div>
            <div class="flex flex-col items-start mt-3">
